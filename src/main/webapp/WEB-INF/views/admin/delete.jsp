...
<section class="login-page">
    <h2>Czy na pewno chcesz usunąć tego admina?</h2>

    <a class="return" style="margin-left: 510px" href="<c:url value="/admin/admins"/>">Powrót</a>
    <form action="<c:url value="/admin/deleting"/>" style="width: 400px" method="post">
        <div style="font-size: 18px; width: 400px">
            ...
            <div style="margin-bottom: 50px; text-align: center">
                <input type="hidden" name="adminId" value="${appUser.id}" />
                <input type="hidden" name="${_csrf.parameterName}"  value="${_csrf.token}" />
                <input type="submit" class="delete" value="Usuń admina">
