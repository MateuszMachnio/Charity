...
<section class="login-page">
    ...
    <a class="return" style="margin-left: 510px" href="<c:url value="/logged-user/profile"/>">Powrót</a>

    <form:form modelAttribute="appUser" action="/logged-user/editing" method="post">
        ...
        <div style="font-size: 18px; width: 750px">
            ...
            <div style="margin-bottom: 50px; text-align: center">
                ...
                <a class="return" href="<c:url value="/logged-user/profile"/>">Anuluj</a>
            </div>
        </div>
